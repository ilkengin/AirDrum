...
public class ArduinoCommunicatorService extends Service {
    ...
    final static String DATA_RECEIVED_INTENT = "ilkengin.airdrum.intent.action.DATA_RECEIVED";
    final static String SEND_DATA_INTENT = "ilkengin.airdrum.intent.action.SEND_DATA";
    final static String DATA_SENT_INTERNAL_INTENT = "ilkengin.airdrum.internal.intent.action.DATA_SENT";
    final static String DATA_EXTRA = "ilkengin.airdrum.intent.extra.DATA";
